...
public class LangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"ABSTRACT", "DATA", "IF", "ELSE", "ITERATE", "READ", "PRINT", "RETURN", 
			"NEW", "INT_TYPE", "CHAR_TYPE", "BOOL_TYPE", "FLOAT_TYPE", "TRUE", "FALSE", 
			"NULL", "ID", "TYID", "INT", "FLOAT", "CHAR", "ESC_SEQ", "LPAREN", "RPAREN", 
			"LBRACK", "RBRACK", "LBRACE", "RBRACE", "SEMI", "COLON", "DBLCOLON", 
			"DOT", "COMMA", "EQ", "LT", "GT", "EQEQ", "NEQ", "PLUS", "MINUS", "MUL", 
			"DIV", "MOD", "AND", "NOT", "LINE_COMMENT", "BLOCK_COMMENT", "WS"
		};
	}
